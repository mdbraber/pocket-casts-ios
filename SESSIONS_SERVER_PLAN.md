...
`sideshow/apns2`, token-based `.p8` key (team D3S5M885YQ, bundle
`com.mdbraber.podcasts`). On session-state write or mirror change: bump cursor,
...
- **APNs**: pusher implemented behind push.Pusher (sideshow/apns2, .p8
  ...
  are set — LIVE since 2026-07-29 (key 5G59MR5628 in the host's ./data,
