...
final class VideoChaptersTests: XCTestCase {
    ...
    func testMatchesTheCompanionEnclosureShape() {
        XCTAssertEqual(videoId("https://owntube-media.home.nedworks.org/enclosure/dQw4w9WgXcQ.m4a"), "dQw4w9WgXcQ")
        XCTAssertEqual(videoId("https://owntube-media.home.nedworks.org/enclosure/dQw4w9WgXcQ.mp4"), "dQw4w9WgXcQ")
    }
