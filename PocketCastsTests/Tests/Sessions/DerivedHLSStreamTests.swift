...
final class DerivedHLSStreamTests: XCTestCase {
    func testDerivesTheLadderFromAProgressiveEnclosure() {
        XCTAssertEqual(
            DerivedHLSStream.url(forEnclosure: "https://owntube-media.home.nedworks.org/enclosure/dQw4w9WgXcQ.mp4")?.absoluteString,
            "https://owntube-media.home.nedworks.org/hls/dQw4w9WgXcQ/master.m3u8"
        )
    }
